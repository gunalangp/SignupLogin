...
import com.example.smartgladiatortask.util.imagepicker.adapter.CustomAlbumSelectAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener((parent, view, position, id) -> {
            if (albums.get(position).name.equals(getString(R.string.capture_photo))) {
                ...
                intent1.putExtra(ConstantsCustomGallery.INTENT_EXTRA_ALBUM, albums.get(position).name);
