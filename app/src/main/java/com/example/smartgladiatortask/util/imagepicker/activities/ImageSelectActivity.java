package com.example.smartgladiatortask.util.imagepicker.activities;
...
import com.example.smartgladiatortask.util.imagepicker.adapter.CustomImageSelectAdapter;
    ...
    private void toggleSelection(int position) {
        if (!images.get(position).isSelected && countSelected >= ConstantsCustomGallery.limit) {
           /* Toast.makeText(
                    ...
                    Toast.LENGTH_SHORT)
                    .show();*/
            new AlertDialog.Builder(ImageSelectActivity.this)
                    .setTitle("Max limit")
                    .setMessage(String.format(getString(R.string.limit_exceeded), ConstantsCustomGallery.limit))
